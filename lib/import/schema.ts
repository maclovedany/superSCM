...
export type FieldRule = { field: string; required?: boolean; kind?: 'number' | 'date'; reference?: 'item' | 'supplier' | 'inventory_status'; quantity?: boolean; enumValues?: readonly string[] };
